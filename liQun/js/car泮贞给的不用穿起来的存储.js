...
//  console.log(total)
        var pro = new Object();
            pro.img = $(this).parents("li").find("img").attr("src");
            pro.name = $(this).attr("data-id");
            pro.price = $(this).siblings().html();
            console.log(pro);
            str.push(pro);
            console.log(str)
           var m = JSON.stringify(str);
            console.log(m)
           window.localStorage.setItem("total",m);
//	this.href = "car.html";
//window.localStorage.clear();
    });
    
    
    var mes = window.localStorage.getItem("total");
     console.log(mes);
//  var total2 = JSON.parse(mes);
//  console.log(mes.length);
//	console.log(valMEs[0].price)
