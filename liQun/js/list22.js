...
//				proData = data;
				for(var i=(pageIndex-1)*20;i<pageIndex*20;i++){//加载json里面的图片，json里面数是从零开始的
					 var html= "<li><a href=\"car.html?pId="+data[i].num+"\"><img  class=\"lazy\"  data-original="+data[i].img+"  src=\"\"/></a>";//当遇到引号时记得要转义
					 ...
					 html+="<a href=\"###\" class=\"intoCar  color3\" data-id="+data[i].num+">加入购物车</a></dd></dl></li>";
...
//  var str ='username='+data[i].name+';path=/;expires='+oDate;;
//  console.log(str);
//  document.cookie = str;	
				}
